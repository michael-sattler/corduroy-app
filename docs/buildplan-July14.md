...
- CLIENT VIEW
   ...
   - [ ] High/medium badges should be color-coded
- STAFF VIEW
   - [ ] Group tasks by week, list in one big list - gantt-chart style?
   - [ ] Test observability logging on KPIs
   - [ ] Create tasks for client
   - [ ] Change Documents to Vault in tab ... add icons
   - [ ] Tighten up admin area
   - [ ] Wire Recent Activity with real metrics
   - [ ] Onboarding pane: Audit doc ingestion and preview
- ROOT
   - [ ] Clean up Preview Deployment
- ALL
   - [ ] Replace STD/WIDE with expand-collapse icons, add slide transitions
